...
l = Languages(name='Angielski (podstawowy)', shortcut='EN-P', level='P' ,is_available=True)
l.save()
l = Languages(name='Angielski (zaawansowany)', shortcut='EN-Z', level='Z' ,is_available=True)
l.save()
l = Languages(name='Rosyjski (podstawowy)', shortcut='RU-P', level='P', is_available=True)
l.save()
l = Languages(name='Rosyjski (zaawansowany)', shortcut='RU-Z', level='Z', is_available=True)
l.save()
l = Languages(name='Niemiecki (podstawowy)', shortcut='DE-P', level='P', is_available=True)
l.save()
